...
case $1 in
	oxford)
		...
		$TEZOSCLIENT originate contract ordering transferring 6 from deploy running ./compiled/ordering/step_002_cont_1_contract.tz --init "$storage" --burn-cap 0.187 --force  >out.tmp 2>&1
