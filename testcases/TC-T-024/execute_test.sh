...
case $1 in
	kathmandu | jakarta | ithaca)
		...
		$TEZOSCLIENT originate contract map_dup transferring 0 from deploy running tickets_dup_bigmap_beforeLima.tz --init "Unit" --burn-cap 0.1 --force  >result.tmp 2>&1
