# Testcase title: Tickets - Create ticket - callback case 2 - address and option

## Description
Naively* trying to create an own ticket from scratch.

We assume that the ticket is just a (pair address cty nat) and can "easily" be created via a callback.
