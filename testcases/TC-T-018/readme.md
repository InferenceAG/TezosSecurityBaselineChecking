# Testcase title: Tickets - Create ticket - call input string/address

## Description
Naively* trying to create an own ticket from scratch.

We assume that the ticket is just a (pair string cty nat) or (pair address cty nat) and can "easily" be created by crafting a transaction to call the entrypoint with this parameter as input.
