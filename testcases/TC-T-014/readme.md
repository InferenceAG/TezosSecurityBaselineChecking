# Testcase title: Tickets - Create ticket - lambda case 3 - string and option

## Description
Naively* trying to create an own ticket from scratch.

We assume that the ticket is just a (pair string cty nat) and can "easily" be created using a lambda.
